...
public class WTFEnv {
  ...
  public WTFEnv(WebDriver driver, WebDriverWait wait, Country country,
      Browser browser, Environment environment, ITestContext context, ITestResult testResult) {
  ...
  public WTFEnv(WebClient webClient, Country country, Browser browser, Environment environment, 
   ...
   * Sets the country.
   */
  public void setSite(Country site) {
    this.country = site;
  }
