...
import org.wtf.core.feature.lint.rhino.css.StringListConverter;
...
public class WTFCommandLineArgs {
  ...
  @Parameter(names = "-site",
             description = "Comma separated site names ex: -site us,uk,de,au,ca,cafr,it,es,fr")
  ...
  @Parameter(names = "-env",
             description = "Comma separated environement to use for running the tests ex: -env qa,prod,preprod")
...
/*  @Parameter(names = "-dash", 
		  description = "Enable srp on dash. ex: srpdash= 0 (non-dash), " +
		  		"srpdash=1 (Enable dash+Vr), srpdash=2|3|4 (Enable only dash),")
  public int dash = -1; */ 
  
  @Parameter(names = "-csslintfolder", description = "Comma separated CSS lint file or folder path",
      converter = StringListConverter.class)
  public List <String> cssLintFolder = new ArrayList <String>();

  @Parameter(names = "-internalBrowserObjectNeverUseThisFlag", hidden = true)
  public List <Browser> wtfBrowsers = new ArrayList <Browser>();
  ...
  public List <Country> wtfSites = new ArrayList <Country>();
