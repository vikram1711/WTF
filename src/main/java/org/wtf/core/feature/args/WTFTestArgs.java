...
public class WTFTestArgs {
  ...
  public static void init() {
    ...
    commandLineArgs.wtfBrowsers =
        new ArrayList <Browser>(new HashSet <Browser>(commandLineArgs.wtfBrowsers));
    commandLineArgs.wtfSites = new ArrayList<Country>(new HashSet<Country>(commandLineArgs.wtfSites));
  ...
  public static String [] readTestArgsFromSystemProperties() {
    ...
    LOG(Level.INFO, String.format("Loading Test Arguments: %s", wtfTestArgFromSysProperty));
